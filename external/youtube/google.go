...
func (c *ClientImpl) NewGoogleRequest(req interface{}) pkg.SyncRequest {
	...
	case *youtube.FetchYoutubeDataListRequest:
		...
		return &google.FetchYoutubeDataRequest{
			...
			Req:    fetchReq,
			Url:    "https://www.googleapis.com/youtube/v3/search?type=video&order=date&publishedAfter=2025-01-01T00:00:00Z&q=politics&key=AIzaSyD6aqoQCvWC8fyH2WNZH-z3ZO2u9gDDxqc",
		}
	default:
		fmt.Println(v)
		return nil
